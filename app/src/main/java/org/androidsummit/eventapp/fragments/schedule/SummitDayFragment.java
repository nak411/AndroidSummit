...
import org.androidsummit.eventapp.adapter.SessionRecyclerAdapter;
...
public class SummitDayFragment extends ParseDataListRetrievalFragment<SummitSession>
    ...
    public static SummitDayFragment newInstance(int sectionNumber, long date) {
    ...
    private void initializeCallbacks(Activity activity) {
